...
exports.homeRouter = (req , res) =>{
    ...
    axios.get('https://asmseverbaohqph13534.herokuapp.com/api/imagees').then(function(response){
...
exports.update_imagees = (req , res) =>{
    axios.get("https://asmseverbaohqph13534.herokuapp.com/api/imagees" , {params: {id: req.query.id}}).then(function (userdata){
